  ...
  return (
    <>
      <div className='w-full h-auto  p-4 flex justify-center gap-4 items-center'>
        <button onClick={() => setCurrentView('download_videos')} className={`w-[155px] h-[35px] text-sm  ${currentView === 'download_videos' ? 'bg-[#afeade]' : 'bg-[#95D2B3]'} rounded-md`}>videos</button>
        ...
        <button onClick={() => setCurrentView('related_videos')} className={`w-[155px] h-[35px] text-sm ${currentView === 'related_videos' ? 'bg-[#afeade]' : 'bg-[#95D2B3]'} rounded-md`}>Related </button>
      </div>
